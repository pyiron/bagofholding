...
version_full = bagofholding.__version__
...
latex_documents = [
  ('index', 'bagofholding.tex', u'bagofholding Documentation',
...
main(['-e', '-o', 'apidoc', '../bagofholding', '--force'])
